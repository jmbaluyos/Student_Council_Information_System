		...
		<div class="row">
			...
			<center><h3>Payment Information</h3></center><br />
				<form>
				  <div class="form-row">
				    <div class="col-md-4">
				      <h6>Event Code: </h6><input type="text" class="form-control" placeholder="Event Code" readonly>
				    </div>
				    <div class="col-md-4">
				      <h6>Penalty: </h6><input type="text" class="form-control" placeholder="Penalty">
				    </div>
				    <div class="col-md-4">
				      <h6>Amount: </h6><input type="text" class="form-control" placeholder="Amount">
				    </div>
				  </div>
				  <br />
				  <div class="form-row">
				    <div class="col-md-4">
				      <h6>Status: </h6><input type="text" class="form-control" placeholder="Status">
				    </div>
				    <div class="col-md-4">
				      <h6>Balance: </h6><input type="text" class="form-control" placeholder="Balance">
				    </div>
				    <div class="col-md-4">
