...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8">
			<center><h2>"Add new Organization"</h2></center><br />
			<center><h3>Organization Information</h3></center><br />
				<form action = "add_new_organization.php" method="POST">
				  <div class="form-row">
				    <div class="col-md-4">
				      <h6>Organization code: </h6><input type="text" class="form-control" name="organization_code" placeholder="Org. code">
				  </div>
				    <div class="col-md-8">
				      <h6>Organization Name: </h6><input type="text" class="form-control" name= "organization_name" placeholder="Organization name">
				    </div>
				  </div>
				  <br />
				  <div class="form-row">
					  <div class="col-md-4">
					  	<a href="list_of_organization.php"><button type="button" class="btn btn-warning">Done</button></a>
