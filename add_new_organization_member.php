			...
			<center><h3>Organization Member Information</h3></center><br />
				<form action = "list_of_department.php" method="POST">
				  <div class="form-row">
				    ...
				    <div class="col-md-8">
				      <h6>Members: </h6><input type="text" class="form-control" name= "organization_member" placeholder="Enter Name">
				    </div>
					<div class="col-md-8">
				      <h6>Academic Year: </h6><input type="text" class="form-control" name= "academic_year" placeholder="Enter Academic Year">
				    </div>
				  </div>
				  <br />
				  <div class="form-row">
