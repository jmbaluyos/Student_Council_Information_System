...
<body>
	...
	<div class="container-fluid">
				<div class="btn-group btn-group-lg" role="group"">
					...
					<a href ="list_of_department.php"><button type="button" class="btn btn-outline-dark">Departments</button></a>
				...
				<table class="table table-primary">
				  ...
				  <tbody>
				    <tr>
				      <td><?php echo $row['academic_code']?></td>
				      <td><?php echo $row['acad_year']?></td>
				      <td><?php echo $row['semester']?></td>
				      <td>
				      	<button type="button" class="btn btn-outline-info btn-sm fa fa-pencil"><a href="update_acad_year.php?Edit3=<?php echo $row['academic_code']; ?>">Edit </a></button> 
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="exampleModalLabel">Delete Academic Year Record</h5>
