				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>
								...
								<button type="button" class="btn btn-outline-info btn-sm fa fa-pencil"><a href="update_program.php?edit=<?php echo $row['course_code']; ?>"> Edit </a></button> 
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="exampleModalLabel">Delete Program Record</h5>
							      ...
							      <div class="modal-footer">
							        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">No</button>
							        	<button type="button" class="btn btn-outline-danger"><a href="server.php?del=<?php echo $row['course_code']; ?>"> Yes </a></button>
							      </div>
							    </div>
							  </div>
							</div>
