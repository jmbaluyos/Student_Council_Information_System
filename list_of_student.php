	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9">	
				...
				<center><h3>List of student</h3></center><br />
				  ...
				  <tbody>
				    <tr>
				      ...
				      <td>		 
						...
						<button type="button" class="btn btn-outline-danger  btn-sm fa fa-trash"><a href="server.php?DEL1=<?php echo $row['id_number']; ?>">Delete</a></button>
				      </td>
				    </tr>
				  </tbody>
				  <?php 
