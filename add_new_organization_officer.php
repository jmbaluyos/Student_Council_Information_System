...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8">
			<center><h2>"Add new Organization Officer"</h2></center><br />
			<center><h3>Organization Officer Information</h3></center><br />
				<form action = "list_of_organization_officer.php" method="POST">
				  <div class="form-row">
				    <div class="col-md-4">
				      <h6>ID#</h6><input type="text" class="form-control" name="" placeholder="Org. code">
					</div>
				    <div class="col-md-8">
				      <h6>Position: </h6><input type="text" class="form-control" name= "" placeholder="Enter Name">
				    </div>
					<div class="col-md-8">
				      <h6>Organization Code: </h6><input type="text" class="form-control" name= "" placeholder="Enter Academic Year">
				    </div>
					<div class="col-md-8">
				      <h6>Academic Year: </h6><input type="text" class="form-control" name= "" placeholder="Enter Academic Year">
				    </div>
				  </div>
				  <br />
				  <div class="form-row">
