...
<body>
	...
	<div class="container-fluid">
				...
				<a href = "add_new_organization_moderator.php"><span style="float: left; font-size: 50px; margin-right: 50px;"><i class="fa fa-plus-circle" font-size = "50px"></i></span></a>
				<center><h3>List of Organization Moderator</h3></center><br />
				<?php $results = mysqli_query($db, "SELECT * FROM org_moderator,academic_year WHERE org_moderator.academic_code=academic_year.academic_code"); ?>
				  ...
				  <tbody>
				    <tr>
							...
							<td>
								...
								<button type="button" class="btn btn-outline-info btn-sm fa fa-pencil"><a href="update_org_moderator.php?edit5=<?php echo $row['instructor_id']; ?>"> Edit </a></button>
