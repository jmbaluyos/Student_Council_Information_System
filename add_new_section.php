...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8">
			<center><h2>"Add new Section"</h2></center><br />
			<center><h3>Section Information</h3></center><br />
				<form action = "add_new_section.php" method = "POST">
				  <div class="form-row">
				    <div class="col-md-6">
				      <h6>Section: </h6><input type="text" name = "section_id" class="form-control" placeholder="Section" max="10">
				  	</div>
				    <div class="col-md-6">
				  ...
				  <div class="form-row">
					  <div class="col-md-4">
					  	<a href="list_of_section.php"><button type="button" class="btn btn-warning">Done</button></a>
