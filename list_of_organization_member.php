				  ...
				  <tbody>
				    <tr>
							...
							<td>
								...
								<button type="button" class="btn btn-outline-info btn-sm fa fa-pencil"><a href="update_org_member.php?EDIT4=<?php echo $row['id_number']; ?>"> Edit </a></button> 
								  ...
								  <div class="modal-dialog" role="document">
								    <div class="modal-content">
								      <div class="modal-header">
								        <h5 class="modal-title" id="exampleModalLabel">Delete Organization Member Record</h5>
