<?php include('server.php'); 
	...
	if (isset($_GET['EDIT4'])) {
		...
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM org_member WHERE id_number='$id_number'");
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-8">
			<center><h2>"Update Organization Member"</h2></center><br />
			<center><h3>Organization Member Information</h3></center><br />
				<form action = "list_of_organization_member.php" method="POST">
				  <div class="form-row">
				    <div class="col-md-4">
				  ...
				  <div class="form-row">
					  ...
					  <?php if ($update == true): ?>
						<button type="submit" class="btn btn-secondary"  name="UPDATE4" style="background: red;">Update</button>
					  <?php else: ?>
