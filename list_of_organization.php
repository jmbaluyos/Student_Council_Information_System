...
<body>
	...
	<div class="container-fluid">
				...
				<a href = "add_new_organization.php"><span style="float: left; font-size: 50px; margin-right: 50px;"><i class="fa fa-plus-circle" font-size = "50px"></i></span></a>
				  ...
				  <tbody>
				    <tr>
							...
							<td>
								...
								<button type="button" class="btn btn-outline-info btn-sm fa fa-pencil"><a href="update_organization.php?edit=<?php echo $row['organization_code']; ?>"> Edit </a></button> 
