				  ...
				  <tbody>
				    <tr>
							...
							<td>
								...
								<button type="button" class="btn btn-outline-info btn-sm fa fa-pencil"><a href="update_section_officer.php?edit8=<?php echo $row['id_number']; ?>"> Edit </a></button> 
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h5 class="modal-title" id="exampleModalLabel">Delete Section Officer Record</h5>
