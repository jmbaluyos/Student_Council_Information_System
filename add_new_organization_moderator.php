		...
		<div class="row">
			...
			<center><h3>Organization Moderator Information</h3></center><br />
				<form action = "list_of_department.php" method="POST">
				  <div class="form-row">
				    <div class="col-md-4">
				      <h6>Instructor ID#</h6><input type="text" class="form-control" name="" placeholder="Org. code">
					</div>
				    <div class="col-md-8">
				      <h6>Lastname: </h6><input type="text" class="form-control" name= "" placeholder="Enter Name">
				    </div>
					<div class="col-md-8">
				      <h6>Firstname: </h6><input type="text" class="form-control" name= "" placeholder="Enter Academic Year">
				    </div>
					<div class="col-md-8">
				      <h6>M.I: </h6><input type="text" class="form-control" name= "" placeholder="Enter Academic Year">
				    </div>
					<div class="col-md-8">
				      <h6>Organization Code: </h6><input type="text" class="form-control" name= "" placeholder="Enter Academic Year">
				    </div>
				  </div>
				  <br />
				  <div class="form-row">
