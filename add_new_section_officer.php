		...
		<div class="row">
			...
			<center><h3>Section Officer Information</h3></center><br />
				<form action = "list_of_organization_officer.php" method="POST">
				  ...
				  <div class="form-row">
					  <div class="col-md-5">
					  	<a href="list_of_section_officer.php"><button type="button" class="btn btn-warning">Done</button></a>
						<button type="reset" class="btn btn-secondary">Reset</button>
						<button type="submit" class="btn btn-primary" name="save8" onclick="myFunction()">Save</button>
					  </div>
				  </div>
				</form>
			</div>
